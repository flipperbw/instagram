...
<html><head><style>
    ...
    div.txt { position: absolute; top: 0px; text-align: center; width: 100%; }
...
for i in s:
    ...
    if fmt not in ('jpg', 'jpeg', 'png', 'bmp', 'tiff'):
        ...
        cont_div = '<div class="cont">{}<div class="img"><img src="{}"><div class="txt hidden"><span>{}</span></div><span class="likes">{}</span><div class="datedown hidden"><span class="dates">{}</span>{}<span data-icon="{}" class="ico"></span></a></div></div></a></div>'
